...
{{if .AddGlobal -}}
// UpsertWithPartialIndexG attempts an insert, and does an update or ignore on conflict with partial index support.
func (o *{{$alias.UpSingular}}) UpsertWithPartialIndexG({{if not .NoContext}}ctx context.Context, {{end -}} updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	return o.UpsertWithPartialIndex({{if .NoContext}}boil.GetDB(){{else}}ctx, boil.GetContextDB(){{end}}, updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...)
}

{{end -}}

{{if and .AddGlobal .AddPanic -}}
// UpsertWithPartialIndexGP attempts an insert, and does an update or ignore on conflict with partial index support. Panics on error.
func (o *{{$alias.UpSingular}}) UpsertWithPartialIndexGP({{if not .NoContext}}ctx context.Context, {{end -}} updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) {
	if err := o.UpsertWithPartialIndex({{if .NoContext}}boil.GetDB(){{else}}ctx, boil.GetContextDB(){{end}}, updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
{{if .AddPanic -}}
// UpsertWithPartialIndexP attempts an insert using an executor, and does an update or ignore on conflict with partial index support.
// UpsertWithPartialIndexP panics on error.
func (o *{{$alias.UpSingular}}) UpsertWithPartialIndexP({{if .NoContext}}exec boil.Executor{{else}}ctx context.Context, exec boil.ContextExecutor{{end}}, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) {
	if err := o.UpsertWithPartialIndex({{if not .NoContext}}ctx, {{end -}} exec, updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...); err != nil {
		panic(boil.WrapErr(err))
	}
}
